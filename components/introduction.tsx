        ...
        <div className="z-20 w-full bg-darkBg/60">
            <div className="z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center max-w-md">
                    ...
                    ¡Hola! Soy estudiante de Ingeniería en Software y desarrollador web. Domino tecnologías como HTML, CSS, JavaScript, PHP y Laravel para crear sitios web funcionales y atractivos. Si buscas un profesional para tu próximo proyecto web, ¡estoy listo para ayudarte!
                    </p>
                    ...
                    <div className="flex items-center justify-center gap-3 md:justify-start md:gap-10">
                        ...
                        <a href="mailto:amielbautista0@gmail.com"
